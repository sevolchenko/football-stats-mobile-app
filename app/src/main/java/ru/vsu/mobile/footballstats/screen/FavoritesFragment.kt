...
import ru.vsu.mobile.footballstats.databinding.FragmentFavoritesBinding
...
class FavoritesFragment : Fragment(), LeagueClickInterface {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.favLeaguesList.observe(viewLifecycleOwner) {
    ...
    override fun onItemClick(id: Int) {
        val action = FavoritesFragmentDirections
            .actionFavoritesFragmentToCurLeagueFragment(
